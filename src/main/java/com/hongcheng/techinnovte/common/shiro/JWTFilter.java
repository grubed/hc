...
//    private Logger logger = LoggerFactory.getLogger(this.getClass());
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) throws Exception {
        ...
        String refreshToken = JWTUtil.generateNewTokenIfRequired(token);
    ...
    private void responseError(ServletRequest request, ServletResponse response, String message) {
        try {
            ...
            httpServletResponse.sendRedirect(request.getServletContext().getContextPath()+"/unauthorized/" + message);
        } catch (IOException e) {
